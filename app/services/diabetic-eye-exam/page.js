  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 sm:py-24 lg:py-32 px-5 sm:px-8 lg:px-16">
        ...
        {/* What We Screen For */}
        <div className="mb-20">
          <h2 className="font-display text-3xl sm:text-5xl lg:text-7xl mb-6">WHAT WE SCREEN FOR</h2>
      ...
      <section className="py-16 sm:py-24 lg:py-32 px-5 sm:px-8 lg:px-16 bg-[#0A1828] text-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-display text-3xl sm:text-5xl lg:text-7xl mb-20 text-center">WHY ANNUAL EXAMS MATTER</h2>
      ...
      <section className="py-16 sm:py-24 lg:py-32 px-5 sm:px-8 lg:px-16 bg-gradient-to-br from-[#C85A3E] to-[#0A1828] text-white text-center">
        <h2 className="font-display text-3xl sm:text-6xl lg:text-8xl mb-8">PROTECT YOUR SIGHT</h2>

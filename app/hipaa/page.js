...
export default function HipaaPage() {
  return (
    ...
    >
      ...
      <div>
        <h3 className="font-bold text-xl text-[#1E2749] mb-3">How We May Use and Disclose Your Health Information</h3>
        <ul className="space-y-3">
          <li className="flex gap-3 text-[#33415C] text-[15.5px] leading-relaxed">
            <span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#B33951] flex-shrink-0"></span>
            <span><b className="text-[#1E2749]">For treatment</b> -- to coordinate your care among our providers and any specialists you&apos;re referred to.</span>
          </li>
          <li className="flex gap-3 text-[#33415C] text-[15.5px] leading-relaxed">
            <span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#B33951] flex-shrink-0"></span>
            <span><b className="text-[#1E2749]">For payment</b> -- to bill insurance providers and process payments for services rendered.</span>
          </li>
          <li className="flex gap-3 text-[#33415C] text-[15.5px] leading-relaxed">
            <span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#B33951] flex-shrink-0"></span>
            <span><b className="text-[#1E2749]">For healthcare operations</b> -- to manage and improve the quality of care we provide.</span>
          </li>
        </ul>
      </div>
      <div>
        <h3 className="font-bold text-xl text-[#1E2749] mb-3">Your Rights</h3>
        <ul className="space-y-3">
          <li className="flex gap-3 text-[#33415C] text-[15.5px] leading-relaxed">
            <span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#B33951] flex-shrink-0"></span>
      ...
      <div>
        <h3 className="font-bold text-xl text-[#1E2749] mb-3">Questions or Concerns</h3>
        <p className="text-[#33415C] text-base leading-relaxed">

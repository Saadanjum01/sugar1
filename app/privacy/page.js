...
export default function PrivacyPage() {
  return (
    ...
    >
      <div>
        <h3 className="font-bold text-xl text-[#093F42] mb-3">1. Information We Collect</h3>
      ...
      <div>
        <h3 className="font-bold text-xl text-[#093F42] mb-3">2. How We Use Your Information</h3>
        <p className="text-[#6E7C77] text-base leading-relaxed">
      ...
      <div>
        <h3 className="font-bold text-xl text-[#093F42] mb-3">3. Cookies and Website Analytics</h3>
        <p className="text-[#6E7C77] text-base leading-relaxed">
      ...
      <div>
        <h3 className="font-bold text-xl text-[#093F42] mb-3">4. Protected Health Information</h3>
        <p className="text-[#6E7C77] text-base leading-relaxed">
          Any protected health information shared with our practice is handled in accordance with HIPAA regulations. See our{' '}
          <a href="/hipaa" className="text-[#37B2B8] font-semibold hover:underline">HIPAA Notice</a> for details on how your medical information is protected.
        </p>
      </div>
      <div>
        <h3 className="font-bold text-xl text-[#093F42] mb-3">5. Contact Us</h3>
        <p className="text-[#6E7C77] text-base leading-relaxed">

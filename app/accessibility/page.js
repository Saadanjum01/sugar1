...
export default function AccessibilityPage() {
  return (
    ...
    >
      <div>
        <h3 className="font-bold text-xl text-[#093F42] mb-3">Our Commitment</h3>
      ...
      <div>
        <h3 className="font-bold text-xl text-[#093F42] mb-3">Accessibility Features</h3>
        <ul className="space-y-3">
          {[
            ...
            <li key={item} className="flex gap-3 text-[#6E7C77] text-[15.5px] leading-relaxed">
      ...
      <div>
        <h3 className="font-bold text-xl text-[#093F42] mb-3">Ongoing Efforts</h3>
        <p className="text-[#6E7C77] text-base leading-relaxed">
      ...
      <div>
        <h3 className="font-bold text-xl text-[#093F42] mb-3">Feedback</h3>
        <p className="text-[#6E7C77] text-base leading-relaxed">
